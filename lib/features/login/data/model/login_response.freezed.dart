...
class _$_LoginResponse implements _LoginResponse {
  const _$_LoginResponse({this.status, this.message, this.data});
...
abstract class _LoginResponse implements LoginResponse {
  const factory _LoginResponse(
      {final bool? status,
      final String? message,
      final Data? data}) = _$_LoginResponse;
    ...
    return _then(_value.copyWith(
      userId: freezed == userId
          ...
          : userId // ignore: cast_nullable_to_non_nullable
              as int?,
      registeredEmail: freezed == registeredEmail
...
class _$_Data implements _Data {
  ...
  @override
  String toString() {
    return 'Data(userId: $userId, registeredEmail: $registeredEmail)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, userId, registeredEmail);
